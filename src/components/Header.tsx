export default function Header() {
    return (
        <header className="absolute flex flex-col justify-center items-center top-0">
            ...
            <form className="relative flex flex-col items-center w-3/12">
                <button className="absolute flex items-center justify-center w-8 h-8 top-0 mt-14 right-0 rounded-r-lg cursor-pointer bg-black z-10 hover:bg-[#3f3f3f]">
